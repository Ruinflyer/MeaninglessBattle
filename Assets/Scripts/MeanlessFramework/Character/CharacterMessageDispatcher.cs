...
public class CharacterMessage
{
    ...
    public CharacterMessage(FSMTransitionType msg, NetworkPlayer rid,bool con)
    {
        Msg = msg;
        Receiver = rid;
        condition = con;
...
public class CharacterMessageDispatcher : Singleton<CharacterMessageDispatcher>
{
    ...
    public void DispatchMesssage(FSMTransitionType msg, NetworkPlayer receiverId, bool condition)
    {
